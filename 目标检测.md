...
![image-20200725212911699](D:\demo\python\paper_encode\目标检测img\image-20200725212911699.png)

<img src="D:\demo\python\paper_encode\目标检测img\image-20200725213024693.png" alt="image-20200725213024693" style="zoom: 67%;" />

## 二、单阶段目标检测

#### 1. YOLOv1

<img src="D:\demo\python\paper_encode\目标检测img\watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2xpdHQxZQ==,size_16,color_FFFFFF,t_70" alt="img" style="zoom:67%;" />

- 将一幅图像分成SxS个网格(grid cell)，如果某个object的中心 落在这个网格中，则这个网格就负责预测这个object。 
  <img src="https://img-blog.csdn.net/20160317163739691" alt="这里写图片描述" style="zoom:33%;" />
- 每个网格要预测B个bounding box，每个bounding box除了要回归自身的位置之外，还要附带预测一个confidence值。 这个confidence代表了所预测的box中含有object的置信度和这个box预测的有多准两重信息，其值是这样计算的： 
  <img src="https://img-blog.csdn.net/20160317154752063" alt="img" style="zoom: 25%;" /> 
...
![img](D:\demo\python\paper_encode\目标检测img\112)

#### 2. YOLOv2

<img src="D:\demo\python\paper_encode\目标检测img\6449203-7a0b7c635ac724a2.png" alt="img" style="zoom: 67%;" />

**k-means clusters**

YOLOv2使用了anchor，但并非手动选取，而是通过聚类的方式学习得到。在训练集上使用k-means算法，距离衡量的方式为：目的使得大框小框的损失同等衡量。

<img src="https://www.zhihu.com/equation?tex=d%28box%2Ccentroid%29+%3D+1+-+IOU%28box%2Ccentroid%29+%5C%5C" alt="公式" style="zoom: 80%;" />
...
![[公式]](D:\demo\python\paper_encode\目标检测img\equation.svg)
...
<img src="D:\demo\python\paper_encode\目标检测img\v2-9e01d1da6e3a4eb4e05432d9721f81c9_720w.jpg" alt="img" style="zoom:33%;" />
...
![img](D:\demo\python\paper_encode\目标检测img\webp11)

#### 3. YOLOv3

<img src="D:\demo\python\paper_encode\目标检测img\3243" alt="img" style="zoom: 50%;" />
...
![preview](D:\demo\python\paper_encode\目标检测img\v2-33c295fa08937aeba4e441312172b6a5_r.jpg)
...
<img src="D:\demo\python\paper_encode\目标检测img\image-20200725211703310.png" alt="image-20200725211703310" style="zoom:67%;" />
...
<img src="D:\demo\python\paper_encode\目标检测img\webp" alt="img" style="zoom: 33%;" />
...
<img src="D:\demo\python\paper_encode\目标检测img\6983308-e7b22a85bf7a6ed9.png" alt="img" style="zoom:33%;" />
...
<img src="D:\demo\python\paper_encode\目标检测img\watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2ZlbmdiaW5nY2h1bg==,size_16,color_FFFFFF,t_70" alt="img" style="zoom: 67%;" />
...
<img src="D:\demo\python\paper_encode\目标检测img\watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzM0MDYzOTg4,size_16,color_FFFFFF,t_70" alt="img" style="zoom: 67%;" />

#### 6. FPN

![这里写图片描述](D:\demo\python\paper_encode\目标检测img\SouthEast)
...
![img](D:\demo\python\paper_encode\目标检测img\5971313-0e2c3b988ea33359.JPG)
...
![img](D:\demo\python\paper_encode\目标检测img\20180309235331207)

#### 7. CoupleNet

​		从RPN生成了候选ROI之后，分两路前进，一路为local FCN，PSRoI pooling提取局部信息；一路为Global FCN提取全局信息，最后融合在一起做判定。

![这里写图片描述](D:\demo\python\paper_encode\目标检测img\SouthEasts)
...
<img src="D:\demo\python\paper_encode\目标检测img\watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2ZhbnpvbmdoYW8=,size_16,color_FFFFFF,t_70" alt="img" style="zoom:67%;" />
...
![img](D:\demo\python\paper_encode\目标检测img\1653638-20190415213512939-1172223382.png)
...
![img](D:\demo\python\paper_encode\目标检测img\1653638-20190415213546410-2000479103.png)
...
<img src="D:\demo\python\paper_encode\目标检测img\v2-6435c34cae5365aaa1b5df1dafe933b6_720w.jpg" alt="img" style="zoom:50%;" />

<img src="D:\demo\python\paper_encode\目标检测img\v2-0d846597e305ff323671c989d74e0c30_720w.png" alt="img" style="zoom: 67%;" />

## 四、多阶段目标检测

#### 1. Cascade R-CNN

![preview](D:\demo\python\paper_encode\目标检测img\v2-7e8c9cf56cc000da4fabfb80fa724465_r.jpg)
...
<img src="D:\demo\python\paper_encode\目标检测img\watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3UwMTMzNjg5OTI=,size_16,color_FFFFFF,t_70" alt="img" style="zoom:67%;" />

## 五、Anchor-Free目标检测

#### 1. CornerNet

<img src="D:\demo\python\paper_encode\目标检测img\70" alt="img" style="zoom: 67%;" />

![图4](D:\demo\python\paper_encode\目标检测img\70sda)

<img src="D:\demo\python\paper_encode\目标检测img\70sd" alt="img" style="zoom: 50%;" />
...
![img](D:\demo\python\paper_encode\目标检测img\watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3UwMTQxMTk2OTQ=,size_16,color_FFFFFF,t_70)
...
<img src="D:\demo\python\paper_encode\目标检测img\watermark,type_ZmFuZ3poZW5naGVpdGk" alt="img" style="zoom:67%;" />

![在这里插入图片描述](D:\demo\python\paper_encode\目标检测img\2121.jpg)
...
<img src="D:\demo\python\paper_encode\目标检测img\watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9" alt="在这里插入图片描述" style="zoom: 67%;" />



#### 4. FCOS

![preview](D:\demo\python\paper_encode\目标检测img\v2-bbec7cf563fc6c0bb981bef30bb9ca17_r.jpg)

![在这里插入图片描述](D:\demo\python\paper_encode\目标检测img\324324.JPG)
...
### 3. 损失函数
 ...
 - 边界框回归
    ...
    - GIoU loss [65] 除了覆盖范围外，还包括了物体的形状和方向
      ...
      ![[公式]](D:\demo\python\paper_encode\目标检测img\equation (1).svg)
...
![img](https://www.52cv.net/wp-content/uploads/2020/06/%E5%BE%AE%E4%BF%A1%E5%9B%BE%E7%89%87_20200605095309.png)
...
- Deformable Conv
  ...
  - DCN  Deformable Convolutional Networks
     ...
     <img src="D:\demo\python\paper_encode\目标检测img\watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2wyMTgxMjY1,size_16,color_FFFFFF,t_70" alt="img" style="zoom:50%;" />

- ResNeSt

<img src="D:\demo\python\paper_encode\目标检测img\watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0d1b19QeXRob24=,size_16,color_FFFFFF,t_70" alt="img" style="zoom:67%;" />
...
- multi-scale（特征金字塔）
  ...
  - BiFPN[77]
    ...
    ![preview](D:\demo\python\paper_encode\目标检测img\v2-225cc89e2308de82aa2267a9a944762f_r.jpg)
...
- <img src="D:\demo\python\paper_encode\目标检测img\SouthEastsfg" alt="float" style="zoom:50%;" />

  Soft-NMS的改进有两种形式，一种是线性加权的：

  <img src="D:\demo\python\paper_encode\目标检测img\v2-31404c122d6577ad7fb40729d03300c6_720w.jpg" alt="img" style="zoom:67%;" />

  一种是高斯加权的：

  ![img](D:\demo\python\paper_encode\目标检测img\v2-b3892078788c9e71bb9afc49f17bdc40_720w.jpg)
...
- Softer-NMS
  ...
  <img src="D:\demo\python\paper_encode\目标检测img\6362fd977cc448d29c8ea68c469ee878.jpg" alt="img" style="zoom: 80%;" />

  ![img](D:\demo\python\paper_encode\目标检测img\e2b9833d872045319804efcafb4a9360.png)
